...
class SiteController extends Controller
{
    ...
    public function actionLogin()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->login() && $model->validateFd()) {          
            return $this->goBack();
        } else {
            $model->password = '';
    ...
    public function actionContact()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->validate()) {
            if ($model->sendEmail(Yii::$app->params['adminEmail'])) {
                Yii::$app->session->setFlash('success', 'Muchas gracias por contactarnos. Vamos a responder lo más pronto posible.');
            } else {
                Yii::$app->session->setFlash('error', 'Ocurrió un error a la hora de enviar el  mensaje.');
            }
